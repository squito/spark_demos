...
object MyBuild extends PomBuild {
  ...
  lazy val sharedSettings = Seq (
    ...
    // same thing for sbt-revolver https://stackoverflow.com/a/28200761/1442961
    // but, sbt doesn't like this ...
    // Revolver.reStart::fullClasspath in reStart <<= fullClasspath in Compile
  )
